...
class RocketLeagueInterface {
  constructor() {
    this.worker = new SharedWorker(new URL('./worker.js', import.meta.url), { name: 'rl.js' } /* webpackChunkName: 'rl-shared-worker.js' */)
    this.listeners = {}
    this.requests = {}
...
export default RocketLeagueInterface
