...
| `docs/`                      | [Architecture](docs/architecture.md) · [Getting started](docs/getting-started.md) · [Working with other people](docs/collaborating.md) · [Collaboration plan](docs/collaboration.md) · [Releasing](docs/releasing.md) |
