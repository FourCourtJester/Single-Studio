...
for (const kind of ['control', 'source']) {
  for (const file of readdirSync(join(types, kind))) {
    ...
    // Keyed by surface as well as name. <Toggle> is a button on the control surface and
...
\`src/sources/\`, one file per OBS browser source, wrapped in a ${air('Scene')}. They read
